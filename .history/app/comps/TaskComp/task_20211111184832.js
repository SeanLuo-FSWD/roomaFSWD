...
<Cont>
 <InputCont>
 <Input1 type="text" placeholder="Add New Task"/> <Input2 type="text" placeholder="Time"/>
 </InputCont>
 ...
 <Day>
     ...
     <ButtonCont>
     <DayButton className="opensans" className="Button">Mon</DayButton>
...
<ButCont>
<Button title="Add" width="122px" margin="0px 40px 40px 0px" onClick={onClick}/>
</ButCont>
  </Cont>
  </MainCont>
}
